...
export interface ApiContentPageContentPage extends Schema.CollectionType {
  ...
  attributes: {
    page_heading: Attribute.String;
    page_category: Attribute.Enumeration<['template', 'quiz', 'video']>;
    Content_UID: Attribute.UID<
    ...
    >;
    page_teaser: Attribute.Media;
    page_tags: Attribute.Component<'metadata.meta-data', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
